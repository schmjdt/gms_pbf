...
repeat (_h - 1) {		
	...
	_c2 = _csv[# 1, _i];
	_c3 = _csv[# 2, _i];
	_c4 = str_to_color(_csv[# 3, _i]);
	_c5 = str_to_lst(_csv[# 4, _i], true);
	...
	ds_map_replace(_tmp_map_2, "name",  _c3);
	ds_map_replace(_tmp_map_2, "color", _c4);
	ds_map_replace(_tmp_map_2, "scale", _c5);
